...
命令行接口，pytube 也提供了 pytube 命令实现通过命令行实现资源下载，通过交互方式实现资源。

视频的命令行下载工具，更著名的 [youtube-dl](https://github.com/ytdl-org/youtube-dl) 和 [you-get](https://github.com/soimort/you-get)，它们比 pytube 出名，如果不是通过 Python 实现资源下载，它们或许是更好的选择。
