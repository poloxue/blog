...
本文是 "构建属于自己的 Web 框架" 系列第三篇：中间件数据共享。
...
博文地址：[从头构建 Go Web 框架（二）](https://www.poloxue.com/posts/2021-10-28-build-your-own-webframework-in-golang-part-2/)，译：[](https://www.nicolasmerouze.com/middlewares-golang-best-practices-examples)。
