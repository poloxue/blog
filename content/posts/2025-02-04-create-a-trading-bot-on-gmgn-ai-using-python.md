...
通过 GMGN.AI 提供的分析能力，筛选潜力代币后，就可以在它的界面上直接交易。除此以外，它还提供了自动化交易机器人。GMGN.AI 的自动化交易机器人是通过 telegram 实现的，如追踪信号、聪明钱包等，都可以在 telegram 中实现。

GMGN.AI 内置的机器人功能相对单一，如果我想自定义交易规则，如按持有人数、流动市值等过滤掉一些不满足条件的币，就需要我们写程序实现了。
